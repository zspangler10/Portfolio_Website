            ...
            <Container maxW={'6xl'} p={6.75} pt={['25vh', '35vh']} h={'100vh'}>
                <VStack>
                    <Heading
                        ...
                        textAlign='center'
                    >
                        <ReactTypingEffect text="Zach Spangler" speed={85} eraseDelay={1000000} typingDelay={650} cursor="_" />
                    </Heading>
                    ...
                    <Fade bottom cascade>
                        <Text
                            ...
                            letterSpacing={1.1}
                        >
                            Project Manager, Data Enthusiast, & Lifelong Learner
                        </Text>
                        <Box p={4}>
